...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { content_provider_id: @zone.content_provider_id, content_rating: @zone.content_rating, description: @zone.description, name: @zone.name } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { content_provider_id: @zone.content_provider_id, content_rating: @zone.content_rating, description: @zone.description, name: @zone.name } }
